...
cd riscv-compliance_ngrriscv
make simulate RISCV_TARGET=ngrriscvsim RISCV_DEVICE=rv32im RISCV_ISA=rv32i
#make simulate RISCV_TARGET=ngrriscvsim RISCV_DEVICE=rv32im RISCV_ISA=rv32im
